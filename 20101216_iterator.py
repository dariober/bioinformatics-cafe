...
ref_db='/exports/work/vet_roslin_nextgen/dario/bwa/indexes/Sscrofa9.56_plus_Human_ribosomal_DNA_complete_repeating_unit.fa'
...
cwd= '/exports/work/vet_roslin_nextgen/dario/bwa/output/20101216_cage_050810_iterate/'
...
for i in range(start_len, end_len+1):
    ...
    script_bwa.write('python ' + os.path.join(cwd, 'rescue_multimappers.py') + '\n\n' )
