...
#
# qsub -P vet_roslin -pe memory 2 -l h_rt=10:00:00 job_20110511_bwa_chipseq_nfkb_lps.sh
...
fastq1='/exports/work/vet_roslin_nextgen/markb/Fastq/110124_EBRI093151_0065/423/lps_nf_s_4_1_sequence.txt'
fastq2='/exports/work/vet_roslin_nextgen/markb/Fastq/110124_EBRI093151_0065/423/lps_nf_s_4_2_sequence.txt'

fastq1_bwa='lps_nf_1.bwa'
fastq2_bwa='lps_nf_2.bwa'
aligned_sam='lps_nf.sam'
aligned_bam='lps_nf.bam'
aligned_q15_bam='lps_nf_q15.bam'
aligned_q15_sorted_bam='lps_nf_q15.sorted'
aligned_q15_bed='lps_nf_q15.bed'
