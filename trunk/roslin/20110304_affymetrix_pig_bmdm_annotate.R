20110304_affymetrix_pig_bmdm_annotate.R
...
venndat<- degenes[, (ncol(degenes)-2):ncol(degenes)]
venndat[is.na(venndat)] <- FALSE
venndat[venndat>0] <- TRUE

vcounts<- vennCounts(venndat)
