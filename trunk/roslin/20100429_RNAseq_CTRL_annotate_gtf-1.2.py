...
pileup_file= '/exports/work/vet_roslin_nextgen/dario/samtools/output/20100409_RNAseq_CTRL_tophat/20100409_RNAseq_CTRL_sscrofa9.56.pileup'

## Assumes NO header in GTF
gtf_file= '/exports/work/vet_roslin_nextgen/dario/GTF/Sus_scrofa.Sscrofa9.56.gtf'

## Output file name
pileup_ann= '/exports/work/vet_roslin_nextgen/dario/samtools/output/20100409_RNAseq_CTRL_tophat/20100409_RNAseq_CTRL_sscrofa9.56.cov'
...
comment= 'GTF file annotated with coverage from RNAseq. Input from pileup file (samtools pileup -s -c -f) from RNAseq_CTRL from tophat (aided by GFF file)'
