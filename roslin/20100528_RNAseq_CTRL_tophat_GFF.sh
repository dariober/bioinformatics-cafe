...
# Use TopHat 1.0.13 to align reads from RNAseq_CTRL (see 27/5/2010 for filtering) against sscrofa 9.56
...
tophat \
  --output-dir /exports/work/vet_roslin_nextgen/dario/tophat/output/20100528_RNAseq_CTRL/ \
  --mate-inner-dist 130 \
  --mate-std-dev 30 \
  --solexa1.3-quals \
  --best \
