#!/exports/applications/apps/SL5/python/2.6.2/bin/python
...
## Output
pileup_outfile= pileup_infile + '.genot'
...
dataset_id= '20100409_RNAseq_LPS'
...
for line in pileup:
    line= line.split('\t')
    if int(line[7]) < 5:
        " Filter out positions covered by less than these many reads "
        continue
