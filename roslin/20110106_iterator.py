...
## Full length FASTQ file, without adapters (not needed?):
...
cwd= '/exports/work/vet_roslin_nextgen/dario/bwa/output/20110106_fantom5_macro_monocyte_vs_ss9'
...
rescue_multimappers= '/exports/work/vet_roslin_nextgen/dario/bwa/output/20110106_fantom5_macro_monocyte_vs_ss9/20110106_rescue_multimappers.py'
...
for i in range(start_len, end_len+1):
    ...
    script_bwa.write(bwa_exe + ' aln -t 2 ' + ref_db + ' ' + fastq + ' > ' + out_bwa) ## Change the number of bwa threads here with -t
    script_bwa.write('\n')
    ...
    if job_id is None:
        ...
        os.system('qsub -P vet_roslin -pe memory 2 -l h_rt=02:00:00 -hold_jid ' +  job_id + ' ' + job)
