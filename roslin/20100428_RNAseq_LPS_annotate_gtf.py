...
pileup_file= 'C:/Tritume/20100409_RNAseq_LPS_sscrofa9.56.pileup.genot'

## Assumes NO header in GTF
gtf_file= 'C:/Tritume/Sus_scrofa.Sscrofa9.56.gtf'

## Output file name
pileup_ann= 'C:/Tritume/20100428_Ss9.56_gtf_RNAseq_LPS.cov'

## Output file comment
## This will be added as first line as comment preceeded by timestamp
comment= 'Created by 20100428_RNAseq_LPS_annotate_gtf.py. GTF file completed with RNAseq coverage from RNAseq_LPS lib'
