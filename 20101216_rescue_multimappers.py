...
sam= open('/exports/work/vet_roslin_nextgen/dario/bwa/output/20101216_cage_050810_iterate/bwa_output.sam')

# Latest FASTQ input that was used for bwa:
multi_fastq= open('/exports/work/vet_roslin_nextgen/dario/bwa/output/20101216_cage_050810_iterate/bwa_input.fq', 'w')
